...
def menu():
    ...
    print 'AUTHOR   : ARIYAN AMHED AKASH'

    print 'FACEBOOK : facebook.com/profile.php?id=100006205997419

    print 'GITHUB     : github.com/ariyqnamhed404'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[AKASH-OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;93m[AKASH-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 01 Days]\x1b[0m \n' 
